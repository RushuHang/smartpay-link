  ...
  return (
    <div
      ...
      className={`group relative flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer transition-all duration-300 ${
        active ? "text-white shadow-lg shadow-brand-primary/20" : "text-blue-100/70 hover:text-white hover:bg-white/5"
      }`}
    >
      {active && (
        <motion.div
          layoutId="activeSidebar"
          className="absolute inset-0 bg-linear-to-r from-white/20 to-white/5 rounded-xl border border-white/10"
