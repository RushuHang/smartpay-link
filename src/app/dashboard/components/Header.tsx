...
import { Bell, Search, User, Sparkles, Settings, LogOut, Menu } from "lucide-react";
  ...
  return (
    <header className="h-20 z-20 flex items-center justify-between px-6 lg:px-10 py-4 bg-white shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-4 bg-slate-100 px-4 py-2.5 rounded-full w-full max-w-[200px] sm:max-w-xs lg:w-80 shadow-sm focus-within:ring-2 focus-within:ring-brand-primary/20 transition-all">
